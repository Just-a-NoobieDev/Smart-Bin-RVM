...
const TransactionReceipt = ({ data }) => (
  <Document>
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.data}>
        <Text>Number of Bottles:</Text>
        <Text>{data.number_bottles}</Text>
      </View>
      <View style={styles.data}>
        <Text>Converted Point/s:</Text>
        <Text>{data.converted_points}</Text>
      </View>
      <View style={styles.data}>
      ...
      <View style={[styles.header, { fontSize: "4mm", marginTop: "4mm" }]}>
        <Text>
