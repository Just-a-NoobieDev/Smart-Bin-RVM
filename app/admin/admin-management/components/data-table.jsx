...
import AddStudent from "./AddAdmin";
    ...
    <div>
      <div className="flex items-center pb-4 md:pb-6 md:pt-4 lg:pt-6 gap-2 md:gap-4 justify-between">
        <Input
          ...
          onChange={(event) =>
            table.getColumn("admin_id")?.setFilterValue(event.target.value)
          }
          ...
          <div className="grid-span-1 flex justify-between gap-1 w-full">
                ...
                {table
                  ...
                  .map((column) => {
                    return (
                      ...
                      >
                        {column.id == "admin_id" ? "Admin Id" : column.id}
                      </DropdownMenuCheckboxItem>
                    );
                  })}
              </DropdownMenuContent>
            ...
            <div className="flex items-center w-full">
              <Button
                ...
                onClick={() => ExportExcel(formattedData, "Admins")}
              >
