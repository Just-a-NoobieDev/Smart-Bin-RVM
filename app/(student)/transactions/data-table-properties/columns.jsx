...
export const Columns = [
  {
    ...
    header: ({ column }) => {
      return (
        ...
        >
          <span className=" whitespace-nowrap text-[12px] md:text-[14px] lg:text-[16px] lg:ml-10 md:ml-5 font-bold">
            Transaction ID
          </span>
    ...
    header: ({ column }) => {
      return (
        <Button
          ...
          onClick={() => column.toggleSorting(column.getIsSorted() === "asc")}
        >
          <span className="text-[12px] md:text-[14px] lg:text-[16px] lg:ml-10 md:-ml-7 -ml-3 font-bold">
            Date
          </span>
          <ArrowUpDown className="ml-2 h-4 w-4" />
        </Button>
